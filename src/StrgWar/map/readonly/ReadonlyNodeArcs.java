...
public class ReadonlyNodeArcs {
	...
	public ReadonlyNodeArcs(Point2D position, double radius, double angle,
			double arcExtent, double lineWidth, Direction direction) {
		_position = position;
		_radius = radius;
		_angle = angle;
	...
	public void draw(GraphicsContext gc, Color color) {
		...
		gc.strokeArc(_position.getX(), _position.getY(),
				_radius * 2, _radius * 2, _angle, _arcExtent, ArcType.OPEN);
	}
}