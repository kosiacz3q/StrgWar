...
public class GameStage extends StrgWar.stage.Stage {
	...
	public GameStage(javafx.stage.Stage primaryStage) throws IOException
	{
		...
		//_canvas = (Canvas)FXMLLoader.load(getClass().getResource("../gui/GameView.fxml"));
	...
	public void OnStart() {
        ...
        _gc.fillPolygon(new double[]{10, 40, 10, 40},
                       new double[]{210, 210, 240, 240}, 4);
        _gc.strokePolygon(new double[]{60, 90, 60, 90},
                         new double[]{210, 210, 240, 240}, 4);
        _gc.strokePolyline(new double[]{110, 140, 110, 140},
                          new double[]{210, 210, 240, 240}, 4);
	}
